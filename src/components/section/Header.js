...
const Header = () => {
    ...
    return (
        <div>
            ...
            <p className="line-1 anim-typewriter">Senior Frontend developer </p>
            ...
            <img id="not-dark" onClick={scrollTo} alt="Contact Me" title="Contact Me" className="gtp" src="daniel.png"></img>
        </div>
    )
